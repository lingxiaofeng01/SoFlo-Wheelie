...
// 定义使用 /games 路由的游戏
const GAMES_ROUTE_SLUGS = ['fortzone-battle-royale', 'stunt-simulator', 'steal-brainrot-duel', 'chicken-jockey-clicker', 'hockey-random', 'bottle-jump', 'scary-wheels', 'wacky-nursery', 'counter-craft-sniper', 'crazy-animal-city', 'dancing-beat', 'cowboy-safari', 'rocket-fortress'];
